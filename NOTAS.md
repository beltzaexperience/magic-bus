...
No usar regex DOTALL sobre bloques grandes.
...
No usar border-bottom rojo manual en subtítulos: el borde rojo solo lo aplica el CSS en .block-tag.

Separadores internos: usar class="sep-line" con opacity: 0.4.
...
Un único marquee-principal; el JS lo gestiona.

Nunca insertar un segundo marquee.
